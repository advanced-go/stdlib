...
func ExampleReadAll_Reader() {
	...
	//Output:
	//test: ReadAll(file://[cwd]/iotest/address3.json) -> [type:*strings.Reader] [buf:72] [status:OK]
	//test: ReadAll(file://[cwd]/iotest/address3.json) -> [type:io.nopCloserWriterTo] [buf:72] [status:OK]
